import { MAXIMUM_HEARTS } from "@/lib/constants";
...
export const units = pgTable("units", {
  ...
  description: text("description").notNull(), // Learn the basics of Burmese
...
export const userProgress = pgTable("user_progress", {
  ...
  userImageSrc: text("user_image_src").notNull().default("/assets/mascot.svg"),
